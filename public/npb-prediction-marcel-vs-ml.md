...
tags:
  ...
  - FastAPI
private: false
updated_at: '2026-02-27T22:34:48+09:00'
...
打者予測ではwOBA/wRC+/wRAAの数値カードと**wRC+推移グラフ**を、投手予測ではFIP/K%/BB%/K-BB%/K9/BB9/HR9の数値カードと**レーダーチャート**を表示します。各指標には計算式と基準値の解説expander付きです。
