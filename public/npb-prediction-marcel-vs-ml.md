...
tags:
  ...
  - FastAPI
private: false
updated_at: '2026-02-26T07:05:04+09:00'
...
ダッシュボードでは計算外選手をチームカードのバッジとexpanderで可視化し、透明性を確保しました。ただし**数値として補完する部分は未実装**です。
...
| **信頼区間の表示** | 計算外選手が多いチームほど予測幅を広げる | ★★★ |

計算外選手が多いチームほど予測の不確実性が高く、「実際の順位がモデルから大きく外れる可能性がある」という情報自体が重要な示唆です。下位予測のチームでも、記録のない選手たちの活躍次第で順位は十分に変わりえます。
